<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:65:"E:\wamp64\www\ms\public/../application/index\view\user\index.html";i:1536580706;s:59:"E:\wamp64\www\ms\application\index\view\layout\default.html";i:1536678084;s:56:"E:\wamp64\www\ms\application\index\view\common\meta.html";i:1535708003;s:59:"E:\wamp64\www\ms\application\index\view\common\sidenav.html";i:1536598103;s:58:"E:\wamp64\www\ms\application\index\view\common\script.html";i:1535708003;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="header-navbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="https://www.fastadmin.net/store.html" target="_blank"><?php echo __('Menu header'); ?></a></li>
                        <li><a href="https://www.fastadmin.net/service.html" target="_blank"><?php echo __('Shi cai'); ?></a></li>
                        <li><a href="https://www.fastadmin.net/download.html" target="_blank"><?php echo __('Store'); ?></a></li>
                        <li><a href="https://www.fastadmin.net/demo.html" target="_blank"><?php echo __('Health'); ?></a></li>
                        <li><a href="https://www.fastadmin.net/donate.html" target="_blank"><?php echo __('Menus header'); ?></a></li>
                        <li><a href="https://forum.fastadmin.net" target="_blank"><?php echo __('Forum'); ?></a></li>
                        <li><a href="https://doc.fastadmin.net" target="_blank"><?php echo __('Blog header'); ?></a></li>
                        <li class="dropdown">
                            <?php if($user): ?>
    ...
    <ul class="list-group">
        ...
        <div class="col-md-9">
            ...
            <div class="panel panel-default ">
                <div class="panel-body">
                    <h2 class="page-header">
                        <?php echo __('My dynamics'); ?>
                        <!--<a href="<?php echo url('user/profile'); ?>" class="btn btn-success pull-right"><i class="fa fa-pencil"></i>-->
                            <!--<?php echo __('Dynamics'); ?></a>-->
                    </h2>
                    <div class="row user-baseinfo">
                        <div class="col-md-3 col-sm-3 col-xs-2 text-center user-center">
                            <a href="<?php echo url('user/profile'); ?>" title="<?php echo __('Click to edit'); ?>">
